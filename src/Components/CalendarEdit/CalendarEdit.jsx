...
import "./CalendarEdit.css"; // Ensure your styles are correct

// Initialize Firebase app and Firestore
const app = initializeApp(firebaseConfig);
const db = getFirestore(app);

const CalendarEdit = ({ monthYear, username }) => {
  ...
  const generateCalendarRecord = async () => {
    try {
      ...
      alert(`${monthYear} calender created`);
    ...
    try {
      ...
      if (passwordDocSnap.exists()) {
        ...
        if (storedPassword === password) {
          ...
          alert("CalendarEdit updated successfully!");
        } else {
